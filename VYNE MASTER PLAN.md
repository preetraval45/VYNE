...
- [~] **Reports & dashboards** — _Done: pipeline-by-stage, win rate, **conversion funnel** with step-conversion %, top deals (in the Forecast/Reports tab) + the CRM dashboard view._ Still to do: by-owner breakdown, velocity, saveable + scheduled-email reports.
