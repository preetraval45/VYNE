  ...
  theme: {
    extend: {
      colors: {
        ...
        vyne: {
          purple: "var(--vyne-purple)",
          "purple-light": "var(--vyne-purple-light)",
          "purple-dark": "var(--vyne-purple-dark)",
        },
        // Drive surface + text utility classes from CSS variables so
        // dark mode swaps automatically. globals.css owns the values.
        content: {
          bg: "var(--content-bg)",
