...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setUser({ id: 'demo', name: 'Preet Raval', email: email || 'preet@vyne.ai', role: 'owner', orgId: 'demo-org', createdAt: new Date().toISOString() })
      setToken('demo-token')
      router.push('/home')
    }
  }
      ...
      >
        ...
        >
          ...
          <p className="text-center text-xs mt-4" style={{ color: '#4A4A6A' }}>
            No backend? Just click <strong style={{ color: '#6C47FF' }}>Sign in</strong> to enter demo mode.
          </p>
        </div>
