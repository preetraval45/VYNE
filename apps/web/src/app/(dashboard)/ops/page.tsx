...
function OverviewTab({
  ...
  return (
    <div>
      {/* Stat cards intentionally removed — the page-level KPI strip
          (PageDashboard at the top of the Ops page) already shows SKUs / low
          stock / orders / revenue, so duplicating them here was redundant. */}
