  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <header
        ...
        style={{ borderBottom: '1px solid #E8E8F0', background: '#FFFFFF' }}
      >
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-8">
        ...
        >
          ...
          <h2 className="text-xl font-semibold mb-3" style={{ color: '#1A1A2E' }}>
            {title} — Coming Soon
          </h2>
          <p className="text-sm max-w-sm mx-auto" style={{ color: '#A0A0B8', lineHeight: '1.6' }}>
            {description}
          </p>
          ...
          >
            <span className="w-2 h-2 rounded-full animate-pulse" style={{ background: '#6C47FF' }} />
            In development
          </div>
        </motion.div>
      </div>
